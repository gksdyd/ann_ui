<template>
    ...
    <div class="right-sidebar-panel p-0">
      <div class="card shadow-none m-0 h-100">
        <div class="card-body px-0 pt-0">
          <div class="p-4">
            ...
            <div class="mt-4 iq-search-bar device-search">
              <form action="#" class="searchbox position-relative">
                ...
                <input
                  type="text"
                  class="text search-input form-control bg-light-subtle"
          ...
          <div class="tabs">
            <div
              class="nav nav-tabs right-sidebar-tabs"
          ...
          <div class="media-height" data-scrollbar="init">
            <div
              class="tab-content right-sidebar-tabs-content"
              id="right-sidebar-tabs"
            >
              <div
                class="tab-content right-sidebar-tabs-content"
                ...
                >
                  ...
                  >
                    <div class="d-flex align-items-center gap-3">
                      ...
                      <div>
                        <h6 class="font-size-14 mb-0 fw-semibold">
                          {{ item.name }}
                        </h6>
                    ...
                    <span class="font-size-12 fw-medium">{{ item.time }}</span>
                  </div>
                </div>
              </div>
              <div
          ...
          <div class="conversion-button">
            <router-link
              :to="{ name: 'chat.chat' }"
              class="btn btn-primary w-100 py-3 d-block rounded-0"
              >View All Conversion</router-link
            >
          </div>
  ...
  <div
    class="chat-popup-modal"
    :class="{ show: modalOpen }"
    id="chat-popup-modal"
  >
    <div
      class="bg-primary p-3 d-flex align-items-center justify-content-between gap-3"
    >
      <div class="d-flex align-items-center gap-3">
        ...
        <div class="content">
          ...
          <span class="d-inline-block lh-1 font-size-12 text-white"
            ><span
              class="d-inline-block rounded-circle bg-success border-5 p-1 align-baseline me-1"
            ></span
            >Avaliable</span
          >
        </div>
      ...
      <div
        class="chat-popup-modal-close lh-1"
        type="button"
      ...
      <ul class="list-inline p-0 mb-0 chat">
        ...
        <li class="mt-2">
          <div class="text-start">
            ...
            <span class="mt-1 d-block time font-size-10 fst-italic"
              >03:41 PM</span
            >
          </div>
        </li>
...
export default {
  ...
  setup() {
    ...
    // Watch for changes in modalOpen and add/remove 'show' class accordingly
    watchEffect(() => {
    ...
    return { modalOpen, openChatModal, closeChatModal };
  },
  data() {
    return {
      miniClass: "",
      chatItems: [
        ...
        {
          src: require("@/assets/images/user/13.jpg"),
          name: "Greta Life",
          message: "hey! how are you?",
          time: "33min",
        },
        {
          src: require("@/assets/images/user/14.jpg"),
          name: "Ira Membrit",
          message: "hey! how are you?",
          time: "33min",
        },
        {
          src: require("@/assets/images/user/15.jpg"),
          name: "Pete Sariya",
          message: "hey! how are you?",
          time: "33min",
        },
        {
          src: require("@/assets/images/user/16.jpg"),
          name: "Monty Carlo",
          message: "hey! how are you?",
          time: "33min",
        },
