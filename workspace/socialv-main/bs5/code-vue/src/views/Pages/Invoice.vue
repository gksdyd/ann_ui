              ...
              <b-row>
                <b-col lg="12">
                  <div class="table-responsive">
                    <table class="table table-invoice" :items="invoice.order">
                      <thead>
                        <tr>
                      ...
                      <thead>
                        <tr class="text-center">
                          <th
                            ...
                            :key="index"
                            :class="item.key === 'item' ? 'text-start' : ''"
                          >
                            {{ item.label }}
                          </th>
                        </tr>
                        ...
                        >
                          ...
                          >
                            ...
                            <td
                              ...
                              :key="item.key + index"
                              :class="
                                item.key === 'total' ? 'font-weight-strong' : ''
                              "
                            >
                              {{ body[item.key] }}
                            </td>
                ...
                <b-col sm="6" class="text-end">
                  <button type="button" class="btn btn-link mr-3">
                    <span class="d-flex align-items-center">
                      <i class="material-symbols-outlined me-1"> print </i>
                      Download Print
                    </span>
                  </button>
                  {{ "" }}
