<template>
              ...
              <div class="row">
                ...
                <div class="col-md-6 col-sm-12">
                  <tab-nav :pills="true" id="pills-tab" class="profile-feed-items d-flex justify-content-end">
                    <tab-nav-items :active="true" id="pills-feed-tab" href="#profile-feed" ariaControls="pills-home"
                      role="tab" :ariaSelected="true" title="Feed" />
                    <tab-nav-items :active="false" id="pills-activity-tab" href="#profile-activity"
                      ariaControls="pills-profile" role="tab" :ariaSelected="false" title="Activity" />
                    <tab-nav-items :active="false" id="pills-friend-tab" href="#profile-friends"
                      ariaControls="pills-contact" role="tab" :ariaSelected="false" title="Friends" />
                    <tab-nav-items :active="false" id="pills-profile-tab" href="#profile-profile"
                      ariaControls="pills-contact" role="tab" :ariaSelected="false" title="profile" />
                  </tab-nav>
                </div>
              </div>
            </div>
          ...
          <tab-content id="pills-tabContent-2">
            <tab-content-item :active="true" id="profile-feed" aria-labelled-by="pills-feed-tab">
              <iq-card body-class="p-0">
                ...
                <div class="user-post">
                  <b-link href="javascript:void(0);"><b-img :src="require('../../assets/images/page-img/p1.jpg')"
                      alt="post-image" fluid /></b-link>
                </div>
                <div class="comment-area p-3">
                  ...
                  <hr>
                  <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Morbi nulla dolor, ornare at commodo non,
                    feugiat non
                  ...
                  <ul class="post-comments p-0 m-0">
                    <li class="mb-2">
                      <div class="d-flex flex-wrap">
                        <div class="user-img">
                          <b-img :src="require('../../assets/images/user/user-2.jpg')" alt="userimg" class="avatar-35"
                            rounded="circle" fluid />
                        </div>
                    ...
                    <li>
                      <div class="d-flex flex-wrap">
                        <div class="user-img">
                          <b-img :src="require('../../assets/images/user/user-3.jpg')" alt="userimg" class="avatar-35"
                            rounded="circle" fluid />
                        </div>
                        <div class="comment-data-block ml-3">
                          <h6>Paul Molive</h6>
  ...
  <b-dropdown-item href="#"><i class="ri-file-copy-line mr-2"></i>Copy Link</b-dropdown-item>
                  ...
                  <hr class="mt-0">
                  <p class="p-3 mb-0">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Morbi nulla dolor, ornare
                    at commodo non,
                    feugiat non nisi. Phasellus faucibus mollis pharetra. Proin blandit ac massa sed rhoncus</p>
                  <div class="comment-area p-3">
                    <hr class="mt-0">
                    <div class="d-flex justify-content-between align-items-center">
                      <div class="d-flex align-items-center">
    ...
    <b-dropdown-item href="#"><i class="ri-file-copy-line mr-2"></i>Copy Link</b-dropdown-item>
            ...
            <tab-content-item :active="false" id="profile-profile" aria-labelled-by="pills-profile-tab">
                ...
                <template v-slot:body>
                  <div class="user-detail text-center">
                    <div class="user-profile">
                      <b-img :src="require('../../assets/images/user/11.png')" alt="profile-img" fluid
                        class="avatar-130" />
                    </div>
              ...
              <iq-card>
                ...
                <template v-slot:body>
                  <div class="user-bio">
                    <p>Tart I love sugar plum I love oat cake. Sweet roll caramels I love jujubes.Topping cake wafer.
                    </p>
                  </div>
          ...
          <iq-card>
            ...
            <template v-slot:body>
              <ul class="media-story m-0 p-0">
                <li v-for="(item, index) in story" :key="index" class="d-flex align-items-center"
            ...
            <template v-slot:body>
              <ul class="suggestions-lists m-0 p-0">
                <li v-for="(item, index) in suggestions" :key="index" class="d-flex mb-4 align-items-center">
                  ...
                  <div class="add-suggestion"><b-link href="javascript:void(0);"><i
                        class="ri-user-add-line"></i></b-link></div>
                </li>
              </ul>
