...
const childRoutes = (prop, mode) => [
  ...
  },
  {
    ...
    meta: { auth: true, name: 'Friend Lists' },
...
const storechildRoutes = (prop, mode = false) => [
  ...
  },
  {
    ...
    meta: { auth: true, name: 'Stores', img: require('../assets/images/page-img/profile-bg7.jpg') },
    component: () => import('../views/SocailMain/Store/productdetail')
  },
  {
    path: 'checkout',
    name: prop + '.checkout',
...
const appChildRoute = (prop, mode = false) => [
  {
    path: 'calendar',
    name: prop + '.calendar',
    meta: { auth: true, name: 'Calendar And Events', img: require('../assets/images/page-img/profile-bg6.jpg') },
