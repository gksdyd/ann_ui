          ...
          >
            <div class="group-info d-flex align-items-center">
              ...
              <div class="info">
                <h4>Developer's...</h4>
                <p class="mb-0 d-flex">
                  <i class="material-symbols-outlined pe-2">lock</i>Private
                  Group . 323 members
                </p>
              </div>
            </div>
          ...
          <div id="post-modal-data" class="card">
            ...
            <div class="card-body">
              ...
              <ul class="post-opt-block d-flex list-inline m-0 p-0 flex-wrap">
                ...
                <li
                  class="bg-primary-subtle rounded p-2 pointer d-flex align-items-center me-3"
                >
                  <img
              ...
              <ul class="list-inline p-0 m-0">
                <li class="mb-3 pb-3 border-bottom">
                  <div class="iq-search-bar members-search p-0">
                    <form action="#" class="searchbox w-auto">
                      <input
                        type="text"
                        class="text search-input bg-grey bg-primary-subtle"
                ...
                <li class="mb-3 d-flex align-items-center">
                  <div
                    class="avatar-40 rounded-circle bg-gray d-flex align-items-center justify-content-center me-3"
                  >
                    <i class="material-symbols-outlined text-dark">explore</i>
                  </div>
                ...
                <li>
                  <button
                    type="submit"
                    class="btn btn-primary d-flex align-items-center d-block w-100"
                  >
