  ...
  <div class="content-inner">
    <b-container>
      <b-row>
        <b-col sm="12">
          <b-card no-body>
            <b-card-body class="profile-page p-0">
        ...
        <b-row>
            ...
            <b-card no-body>
              ...
              <b-card-body>
                <ul class="list-inline p-0 m-0">
                  ...
                  <li class="mb-2 d-flex align-items-center">
                    <span class="material-symbols-outlined md-18"> place </span>
                  ...
                  <ul class="profile-img-gallary p-0 m-0 list-unstyled">
                    <li class="">
                      <a
                        ...
                        :href="require('@/assets/images/page-img/g1.jpg')"
                        ><img
                    ...
                    <li class="">
                      <a
                        data-fslightbox="gallery"
                        :href="require('@/assets/images/page-img/g2.jpg')"
                        ><img
                    ...
                    <li class="">
                      <a
                        data-fslightbox="gallery"
                        :href="require('@/assets/images/page-img/g3.jpg')"
                        ><img
                    ...
                    <li class="">
                      <a
                        data-fslightbox="gallery"
                        :href="require('@/assets/images/page-img/g4.jpg')"
                        ><img
                    ...
                    <li class="">
                      <a
                        data-fslightbox="gallery"
                        :href="require('@/assets/images/page-img/g5.jpg')"
                        ><img
                    ...
                    <li class="">
                      <a
                        data-fslightbox="gallery"
                        :href="require('@/assets/images/page-img/g6.jpg')"
                        ><img
                    ...
                    <li class="">
                      <a
                        data-fslightbox="gallery"
                        :href="require('@/assets/images/page-img/g7.jpg')"
                        ><img
                    ...
                    <li class="">
                      <a
                        data-fslightbox="gallery"
                        :href="require('@/assets/images/page-img/g8.jpg')"
                        ><img
                    ...
                    <li class="">
                      <a
                        data-fslightbox="gallery"
                        :href="require('@/assets/images/page-img/g9.jpg')"
                        ><img
          ...
          <b-col lg="8">
            <b-card no-body id="post-modal-data">
              <div class="card-header d-flex justify-content-between">
                <div class="header-title">
                  <h4 class="card-title">Create Post</h4>
                </div>
              </div>
              <b-card-body data-toggle="modal" data-target="#post-modal">
                  ...
                  <div class="comment-area mt-3">
                    ...
                    >
                      ...
                      <div class="comment-attagement d-flex">
                        <a href="#" class="material-symbols-outlined me-3 link">
                          insert_link
                        </a>
                        <a href="#" class="material-symbols-outlined me-3">
                          sentiment_satisfied
                        </a>
                        <a href="#" class="material-symbols-outlined me-3">
                          photo_camera
