            ...
            <div class="card-body">
              <form>
                <div class="form-group">
                  <label class="form-label" for="country-and-timezone"
                    >Country and Timezone</label
                  >
                ...
                <div class="form-group">
                  <label class="form-label" for="extended-days"
                    >Extended Days</label
                  >
                ...
                <div class="form-group">
                  <label class="form-label" for="temperature-unit"
        ...
        <div class="col-lg-6">
          <div class="card card-block card-stretch card-height">
            <div class="card-body p-0">
              <leaflet id="weather-chart" :options="leafletoptions" style="height: 380px;" />
            </div>
          </div>
        </div>
        <div class="col-lg-3">
          <div
            class="card card-block card-stretch card-height bg-primary rounded text-white"
          >
            <div class="card-body p-4">
              <div class="text-center">
                ...
                <ul
                  class="d-flex align-items-center justify-content-between list-inline m-0 p-0 weather-list"
                >
        ...
        <div class="col-sm-12">
          <iq-card>
            <div class="card-body bg-info rounded text-white">
              <ul
                class="iq-week-data d-flex justify-content-between list-inline m-0 p-0 flex-wrap"
              >
                <li
                ...
                >
                  ...
                  <div class="weather-icon mt-3 mb-3 font-size-20">
                    <i :class="item.icon">{{ item.iconName }}</i>
                  </div>
...
<script setup>
import { ref } from "vue";
import leaflet from "../../../components/custom/leaflet/leaflet";
...
const otherInfo = [
  {
    heading: "Yesterday",
    class: "material-symbols-outlined text-white md-18",
    value: "21 ",
    icon: "thunderstorm",
  },
  {
...
const dayWise = [
  {
    day: "Sunday",
    icon: "material-symbols-outlined md-18",
    value: "13 ° 7 °",
