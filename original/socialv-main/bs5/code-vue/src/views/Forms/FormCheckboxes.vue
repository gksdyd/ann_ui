    ...
    <b-container>
      <b-row>
        <b-col sm="12">
          <b-card
            no-body
            class="position-relative inner-page-bg bg-primary"
            style="height: 150px"
          >
            ...
            <b-card-body class="pt-0">
              ...
              >
                <input
                  ...
                  id="customCheck-11"
                />
                <label class="form-check-label" for="customCheck-11"
                  >Primary</label
                >
              </div>
              {{ "" }}
              ...
              >
                <input
                  ...
                  id="customCheck-22"
                />
                <label class="form-check-label" for="customCheck-22"
                  >Success</label
                >
              </div>
              {{ "" }}
              ...
              >
                <input
                  ...
                  id="customCheck-33"
                />
                <label class="form-check-label" for="customCheck-33"
                  >Danger</label
                >
              </div>
              {{ "" }}
              ...
              >
                <input
                  ...
                  id="customCheck-44"
                />
                <label class="form-check-label" for="customCheck-44"
                  >Warning</label
                >
              </div>
              {{ "" }}
              ...
              >
                <input
                  ...
                  id="customCheck-55"
                />
                <label class="form-check-label" for="customCheck-55"
                  >Dark</label
                >
              </div>
              {{ "" }}
              ...
              >
                <input
                  ...
                  id="customCheck-66"
                />
                <label class="form-check-label" for="customCheck-66">
                  Info</label
                >
              </div>
            </b-card-body>
            ...
            <b-card-body class="pt-0">
              ...
              <div class="form-check form-check-inline me-2">
                <input
                  ...
                  id="customCheck-f"
                />
                <label class="form-check-label" for="customCheck-f"
                  >False</label
                >
              </div>
            </b-card-body>
            ...
            <b-card-body class="pt-0">
              ...
              <div class="form-check form-checkbox form-check-inline">
                ...
                <label class="form-check-label" for="customCheck7"
                  >Primary - inactive - disabled</label
                >
              </div>
              {{ "" }}
            ...
            <b-card-body class="pt-0">
              ...
              <div class="form-check form-checkbox form-check-inline">
                <input
                  ...
                  checked=""
                />
                <label class="form-check-label" for="customCheck-1">
                  Primary</label
                >
              </div>
              {{ "" }}
              <div class="form-check form-checkbox form-check-inline">
                <input
                  ...
                  checked=""
                />
                <label class="form-check-label" for="customCheck-2"
                  >Success</label
                >
              </div>
              {{ "" }}
              <div class="form-check form-checkbox form-check-inline">
                <input
                  ...
                  checked=""
                />
                <label class="form-check-label" for="customCheck-3"
                  >Danger</label
                >
              </div>
              {{ "" }}
              <div class="form-check form-checkbox form-check-inline">
                <input
                  ...
                  checked=""
                />
                <label class="form-check-label" for="customCheck-4"
                  >Warning</label
                >
              </div>
              {{ "" }}
