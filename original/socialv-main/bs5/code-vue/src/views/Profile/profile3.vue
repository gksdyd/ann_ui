<template>
    ...
    <div class="container">
      ...
      <div class="row mt-1">
        <div class="col-md-4 col-lg-4">
          <div class="fixed-md-suggestion mb-4">
            <div class="card">
              <div class="card-body p-0">
                <div class="tab-bottom-bordered">
                  <ul
                    class="mb-0 nav nav-tabs rounded-top border-0 d-flex align-items-center justify-content-center profile-feed-items p-0 m-0"
                  >
                    ...
                    <li class="nav-item col-12 col-sm-3 p-0">
                      <a
                        class="nav-link border-0 px-md-0"
                        href="#Abouts"
                        data-bs-toggle="pill"
        ...
        <div class="col-md-8 col-lg-8">
          <div id="post-modal-data" class="card">
            ...
            <div class="card-body">
              ...
              <hr />
              <ul
                class="post-opt-block d-flex list-inline m-0 p-0 flex-wrap gap-3"
              >
                <li
                  class="bg-primary-subtle rounded p-2 pointer d-flex align-items-center"
                >
                  <img
                ...
                <li
                  class="bg-primary-subtle rounded p-2 pointer text-center pb-0"
                >
                  <div class="card-header-toolbar d-flex align-items-center">
                    <div class="dropdown">
                      <div
          ...
          <div class="card">
            <div class="card-body">
              ...
              <hr />
              <ul
                class="nav tab-nav-pane nav-tabs grid justify-content-evenly mb-0"
              >
                <li class="pb-0 mb-0 nav-item">
                  <a
                    data-bs-toggle="tab"
                    class="font-weight-bold text-uppercase nav-link active d-flex align-items-center"
                    href="#Listview"
                  >
                ...
                <li class="pb-0 mb-0 nav-item">
                  <a
                    data-bs-toggle="tab"
                    class="font-weight-bold text-uppercase ms-3 nav-link d-flex align-items-center"
                    href="#Gridview"
                  >
                    <span class="material-symbols-outlined md-18 me-1">
                      grid_view
              ...
              <div class="tab-content">
                ...
                >
                  <div class="">
                    <div
                      class="card-header d-flex justify-content-between px-0"
                    >
                      <div class="header-title">
                    ...
                    <div class="card-body p-0 pt-3">
                      <ul class="request-list list-inline m-0 p-0">
                        <li
                          class="d-flex align-items-center justify-content-between flex-wrap"
                          v-for="(sweet, index) in SweetAlert"
                          :key="index"
                        >
                          <div class="user-img img-fluid flex-shrink-0">
                            <img
                          ...
                          <div class="flex-grow-1 ms-3">
                            <h6>{{ sweet.name }}</h6>
                            <p class="mb-0">{{ sweet.friend }}</p>
                          </div>
                          <div class="d-flex align-items-center mt-2 mt-md-0">
                            <div class="confirm-click-btn">
                              <a
                                href="#"
                                class="me-2 btn btn-primary-subtle rounded confirm-btn p-1 lh-1"
                                ><i
                                  class="material-symbols-outlined font-size-14"
                                >
                                  add
                                </i></a
                              >
                        ...
                        <div class="card-body">
                          <div class="iq-badges text-left">
                            <div class="badges-icon">
                              <img
                                class="avatar-80 rounded"
                                :src="user.image"
                                alt="User Avatar"
                                loading="lazy"
                              />
                            </div>
                            <h5 class="mb-2">{{ user.badge }}</h5>
                            <p>{{ user.description }}</p>
                            <span class="text-uppercase"
                              >Unlock {{ user.unlockDate }}</span
                            >
                          </div>
                        </div>
                      </b-card>
  ...
  <FsLightbox
    ...
    :sources="[
      ...
      require('@/assets/images/page-img/g9.jpg'),
    ]"
  />
</template>
<script>
...
export default {
  ...
  data() {
    return {
      ...
      items: [
        {
          user: {
            name: "Bni Cyst",
            profileLink: "#",
            avatar: require("@/assets/images/user/03.jpg"),
            action: "Share Anna Mull's Post",
            time: "5 hours ago",
          },
          post: {
            imageUrl: require("@/assets/images/page-img/p3.jpg"),
            imageLink: "#",
          },
        },
        {
          ...
          post: {
            imageUrl: require("@/assets/images/page-img/fun.jpg"),
            imageLink: "#",
          },
        },
        {
          ...
          post: {
            imageUrl: require("@/assets/images/page-img/p1.jpg"),
            imageLink: "#",
          },
        },
      ],
      users: [
        {
          image: require("@/assets/images/badges/01.png"),
          badge: "Gold User",
          description: "Richard McClintock, a Latin professor consectetur.",
          unlockDate: "Jan 15th, 2020",
        },
        {
          image: require("@/assets/images/badges/02.png"),
          badge: "Gold User",
          description: "Richard McClintock, a Latin professor consectetur.",
          unlockDate: "Jan 15th, 2020",
        },
