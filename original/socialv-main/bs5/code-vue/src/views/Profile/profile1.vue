          ...
          <div class="card">
            <div class="card-body">
              <div class="text-center">
                <img
                  class="img-fluid rounded-circle avatar-130"
                ...
                <p>
                  Multidisciplinary photographer focused on travel and nature
                  content
                </p>
              </div>
                  ...
                  <ul class="list-unstyled">
                    <li class="mb-4">
                      ...
                      <span class="text"
                        ...
                        for the “Daydreams” Agency in Pier 56.</span
                      >
                    </li>
                    <li class="mb-4">
                      ...
                      <span class="text"
                        ...
                        Running Dead, Found, American Guy.</span
                      >
                    </li>
                    <li class="mb-4">
        ...
        <div class="col-lg-6">
          <div class="card">
            <nav class="tab-bottom-bordered">
              <div
                class="mb-0 nav nav-tabs rounded-top border-0"
                id="nav-tab1"
                role="tablist"
              >
                <button
            ...
            <div
              class="tab-content iq-tab-fade-up card-body"
              id="nav-tabContent"
            >
              <div
              ...
              >
                <div class="borderbox1 d-flex">
                  ...
                  <div class="border rounded p-2">
                    ...
                    >
                      <div class="d-flex align-items-center">
                        ...
                        <span class="ms-1 d-flex align-items-center">
                          <i
                            class="material-symbols-outlined me-2 text-primary md-16"
                          >
                            check_circle </i
                          >@john_ram
                        </span>
                    ...
                    <div
                      class="d-flex flex-wrap justify-content-evenly mb-0 mt-2"
                    >
                      <div class="d-flex align-items-center">
                      ...
                      <hr class="hr-vertical" />
                      <i
                        class="material-symbols-outlined icon-rtl md-16 icon-22"
                      >
                        shortcut
                      </i>
                    </div>
                  ...
                  <div class="borderbox border rounded p-2">
                    ...
                    >
                      <div class="d-flex align-items-center">
                        <h6>John Ramsey</h6>
                        <span
                          class="text-primary ms-1 d-flex align-items-center"
                        >
                          <i
                            class="material-symbols-outlined me-2 text-primary md-16"
                          >
                    ...
                    <div class="row mt-2">
                      <div class="col-lg-4 col-md-6 mt-1">
                        <img
                          src="@/assets/images/page-img/57.jpg"
                      ...
                      <div class="col-lg-4 col-md-6 mt-1">
                        <img
                          src="@/assets/images/page-img/58.jpg"
                          class="img-fluid rounded"
                          alt="Responsive image"
                          loading="lazy"
                        />
                      ...
                      <div class="col-lg-4 col-md-6 mt-1">
                        <img
                          src="@/assets/images/page-img/59.jpg"
                          class="img-fluid rounded"
                          alt="Responsive image"
                          loading="lazy"
                        />
                ...
                <div class="borderbox1 d-flex mt-3">
                  ...
                  <div class="border rounded p-2">
                    ...
                    >
                      ...
                      <div class="d-flex align-items-center">
                        <i
                          class="material-symbols-outlined md-16 text-danger icon-22 icon-22"
                        >
                          favorite_border
                        </i>
                        <h6 class="ms-2">426</h6>
              ...
              >
                <div class="card-body p-0 mb-3">
                  <div class="borderbox border p-2 rounded">
                    ...
                    <span class="mt-1"
                      ...
                      Tweets.Design Twitter is full of folks who Tweet well, and
                      we want to figure out the secret to their sauce.</span
                    >
                ...
                <div class="borderbox border p-2 rounded mb-3">
                  ...
                  <div class="row mt-2">
                    <img
                      src="@/assets/images/page-img/fun.jpg"
                      alt="post-image"
                      class="img-fluid w-100"
                    />
                  </div>
                  ...
                  >
                    ...
                    <div class="d-flex align-items-center">
                      <i
                        class="material-symbols-outlined md-16 text-danger icon-22"
                      >
                        favorite_border
                      </i>
                      <h6 class="ms-2">47</h6>
                ...
                <div class="borderbox border p-2 rounded mb-3">
                  ...
                  <div class="row mt-2">
                    <img
                      src="@/assets/images/page-img/mountain.jpg"
                      alt="post-image"
                      class="img-fluid w-100"
                      loading="lazy"
                    />
                ...
                <div class="borderbox border p-2 rounded mb-3">
                  ...
                  <div class="row mt-2">
                    <img
                      src="@/assets/images/page-img/bus.jpg"
                      alt="post-image"
                      class="img-fluid w-100"
                      loading="lazy"
                    />
                ...
                <div class="borderbox border p-2 rounded">
                  ...
                  <div class="row mt-2">
                    <img
                      src="@/assets/images/page-img/boy.jpg"
                      alt="post-image"
                      class="img-fluid w-100"
                    />
                  </div>
                  ...
                  >
                    ...
                    <hr class="hr-vertical" />
                    <i class="material-symbols-outlined md-16 icon-rtl icon-22">
                      shortcut
                    </i>
                  </div>
                </div>
              ...
              >
                <div class="borderbox1 d-flex mb-3">
                  ...
                  <div class="borderbox border rounded p-2">
                    ...
                    <h6 class="mt-2 font-size-14">
                      Best views from the vactions
                    </h6>
                    <div class="row mt-2">
                      <div class="col-lg-4 col-md-6 mt-1">
                        <img
                ...
                <div class="borderbox1 d-flex mb-3">
                  ...
                  <div class="borderbox border rounded p-2">
                    ...
                    <div class="row mt-2">
                      ...
                      <div class="col-lg-4 col-md-6 mt-1">
                        <img
                          src="@/assets/images/page-img/61.jpg"
                          class="img-fluid rounded"
                          alt="Responsive image"
                          loading="lazy"
                        />
                      ...
                      <div class="col-lg-4 col-md-6 mt-1">
                        <img
                          src="@/assets/images/page-img/62.jpg"
                          class="img-fluid rounded"
                          alt="Responsive image"
                          loading="lazy"
                        />
                ...
                <div class="borderbox1 d-flex mb-3">
                  ...
                  <div class="borderbox border rounded p-2">
                    ...
                    <div class="row mt-2">
                      <div class="col-lg-4 col-md-6 mt-1">
                        <img
                          src="@/assets/images/page-img/63.jpg"
                          class="img-fluid rounded"
                          alt="Responsive image"
                        />
                      </div>
                      <div class="col-lg-4 col-md-6 mt-1">
                        <img
                          src="@/assets/images/page-img/64.jpg"
                          class="img-fluid rounded"
                          alt="Responsive image"
                        />
                      </div>
                      <div class="col-lg-4 col-md-6 mt-1">
                        <img
                          src="@/assets/images/page-img/65.jpg"
                          class="img-fluid rounded"
                          alt="Responsive image"
                        />
                      </div>
        ...
        <div class="col-lg-3">
            ...
            <div class="card-body">
              <ul class="list-unstyled m-0 p-0">
                <li class="border-bottom pb-3">
                  <a href="#" class="h5"
                    >My Perfect Vacations in South America and Europe</a
                  >
                  <p>
                  ...
                  <div class="post__date">
                    <span class="published"> 7 hours ago </span>
                  </div>
                </li>
                <li class="pt-3">
                  <a href="#" class="h5"
                    >The Big Experience of Travelling Alone</a
                  >
                  <p>
                    Lorem ipsum dolor sit amet, consect adipisicing elit, sed do
                    eiusmod por incidid ut labore et.
                  ...
                  <div class="post__date">
                    <span class="published"> March 18th, at 6:52pm </span>
                  </div>
                </li>
              </ul>
            </div>
          ...
          <div class="card">
            ...
            >
              ...
              <i class="material-symbols-outlined icon-rtl md-16"> shortcut </i>
            </div>
            <div class="card-body">
              <ul class="list-inline m-0 p-0">
                <li class="d-flex mb-3 align-items-center">
                  ...
                  <div class="ms-2 flex-grow-1">
                    <h6 class="d-flex align-items-center frd-name">
                      Kate
                      <i
                  ...
                  <a href="#" class="btn btn-primary-subtle smallbutton"
                    >follow</a
                  >
                </li>
                <li class="d-flex mb-3 align-items-center">
