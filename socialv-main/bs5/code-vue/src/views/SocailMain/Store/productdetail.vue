<template>
  <div class="content-inner">
    <b-container>
          ...
          <b-row class="align-items-center">
            ...
            <b-col lg="5">
              <div class="border-bottom pb-3 mb-3 pt-5 pt-lg-0">
                <div
                  class="d-flex flex-column align-content-between justify-items-center mb-2"
                >
                  <div class="d-flex justify-content-between">
                    <h3 class="mb-2 fw-semibold">Leather Bags</h3>
                    <div
                    ...
                    >
                      <a
                        ...
                        data-bs-target="#modal-share-offcanvas"
                        aria-controls="share-btn"
                        class="d-flex align-items-center"
                      >
                        <span
                          class="material-symbols-outlined align-text-top font-size-20 bg-light-subtle text-dark rounded p-2"
                        >
                          share
                        </span>
                      </a>
                  ...
                  <div class="d-flex align-items-center w-100">
                    ...
                    <span class="ms-1 font-size-14 fw-semibold text-capitalize"
                      >(4 customer review)</span
                    >
                  </div>
                </div>
                <h4 class="fw-semibold font-size-18 mb-3">$49.99</h4>
                <p class="text-body fw-semibold text-capitalize mb-0">
              ...
              <div class="border-bottom pb-4 mb-4">
                ...
                <h6 class="fw-semibold mb-2">
                  Color:<span class="ms-1 fw-normal">Green</span>
                </h6>
                <ul class="d-flex list-inline mb-4">
                  <li class="border rounded-circle me-3">
                    <a href="#" class="product-color bg-secondary"></a>
                  </li>
                  <li class="border rounded-circle me-3">
                    <a href="#" class="product-color bg-primary"></a>
                  </li>
                  <li class="border rounded-circle me-3">
                    <a href="#" class="product-color bg-success"></a>
                  </li>
                  <li class="border rounded-circle me-3">
                    <a href="#" class="product-color bg-danger"></a>
                  </li>
                  <li class="border rounded-circle me-3">
                    <a href="#" class="product-color bg-warning"></a>
                  </li>
                </ul>
                <div class="d-flex align-items-center gap-3">
                  ...
                  <button
                    type="button"
                    class="btn btn-primary fw-semibold font-size-14 w-50"
                  >
                    Add to cart
                  </button>
                </div>
          ...
          <b-row class="mt-5 pt-4">
            <b-col lg="12">
              <div class="product-detail-tabs">
                <ul
                  class="nav nav-tabs justify-content-center gap-4 mb-3 gap-lg-5 border-bottom"
                  id="product-tab"
                  role="tablist"
                >
                  ...
                  <li class="nav-item" role="presentation">
                    <a
                      href="javascript:void(0)"
                      class="nav-link bg-transparent px-0 py-2 fs-5 rounded-0"
                      data-bs-toggle="tab"
                ...
                <div class="tab-content" id="product-tab-content">
                      ...
                      <ul class="list-inline m-0 p-0">
                        <li class="p-4 border rounded mb-4">
                          <div class="d-flex flex-sm-row flex-column gap-3">
                            <div class="user-image flex-shrink-0">
                              <img
                                src="@/assets/images/page-img/19.jpg"
                                class="avatar-120"
                                alt=""
                                loading="lazy"
                              />
                            ...
                            <div class="about-user">
                              ...
                              <small href="#" class="text-primary"
                                >March 01st 2021</small
                              >
                              <p class="mt-1 mb-0">
                        ...
                        <li class="p-4 border rounded">
                          <div class="d-flex flex-sm-row flex-column gap-3">
                            <div class="user-image flex-shrink-0">
                              <img
                                src="@/assets/images/page-img/22.jpg"
                                class="avatar-120"
                                alt=""
                                loading="lazy"
                              />
                        ...
                        <b-col lg="12">
                          <div class="form-group">
                            <label for="message" class="form-label"
                              >Enter your Review<span class="text-danger"
                                >*</span
                              ></label
                            >
                            <textarea
                  ...
                  <div class="tab-pane fade" id="storedetail" role="tabpanel">
                    <div class="d-flex align-items-center gap-3">
                      <img
                        src="@/assets/images/store/product-detail/store.png"
                        alt=""
                        loading="lazy"
                      />
                      <div>
                        ...
                        <div
                          class="d-flex align-items-center w-100 mt-2 flex-wrap"
                        >
                          <svg
                            class="icon-24"
                            width="24"
                          ...
                          <span
                            class="ms-1 font-size-14 fw-semibold text-capitalize"
                            >(4 customer review)</span
                          >
                        </div>
                      </div>
                    </div>
                    <div class="table-responsive store-detail-table mb-0">
                      <table class="mt-5 pt-2">
                        <tr>
                          ...
                          <td class="w-75">
                            492 Devon StreetMissoula, MT 59801, united states
                          </td>
                        </tr>
                        <tr>
                          <th class="w-25">
                          ...
                          <td class="w-75">
                            <h6 class="text-capitalize fw-normal mb-2">
                              mon to fri:<span class="text-body ms-2"
                                >08:00 AM - 16:00 PM</span
                              >
                            </h6>
                            <h6 class="text-capitalize fw-normal">
                              Weekends:<span class="text-body ms-2"
                                >Closed</span
                              >
                            </h6>
                          </td>
                        ...
                        <tr>
                          ...
                          <td class="w-75">
                            <ul
                              class="list-inline d-flex align-items-center gap-2 mb-0"
                            >
                              <li>
                                <svg
                                  xmlns="http://www.w3.org/2000/svg"
      ...
      <div
        class="swiper-general overflow-hidden"
        data-slide="3"
        data-laptop="2"
        data-tab="1"
        data-mobile="1"
      ...
      >
        ...
        >
          <swiper-slide
            ...
            class="swiper-slide"
          >
            <b-card no-body class="card-block card-stretch card-height product">
              <b-card-body>
                <div
                ...
                >
                  <div class="d-flex align-items-center">
                    <img
                      class="img-fluid rounded-circle avatar-30"
                ...
                <div class="image-block position-relative">
                  ...
                  <div
                    class="offer"
                    :class="{
                      'bg-danger': product.offerPercentage === '50%',
                    }"
                  >
                  ...
                  <h6 class="price">
                    <span class="regular-price text-dark pr-2">
                ...
                <div class="product-description mt-3">
                  <a :href="product.productLink" class="mb-1">{{
                    product.productName
                  }}</a>
                  <p
                    class="categry text-primary ps-3 mb-0 position-relative mb-0"
                  >
                    {{ product.category }}
                  </p>
...
import ShareOffcanvas from "@/components/shareOffcanvas.vue";
import { ref, onMounted } from "vue";
import groupbtn from "@/components/custom/quantitybtn/quantitybtn1.vue";

const modules = [Navigation, Controller];
const items1 = [
  { images: require("@/assets/images/store/product-detail/01.jpg") },
  { images: require("@/assets/images/store/product-detail/02.jpg") },
  { images: require("@/assets/images/store/product-detail/3.jpg") },
  { images: require("@/assets/images/store/product-detail/04.jpg") },
  { images: require("@/assets/images/store/product-detail/05.jpg") },
];
const items2 = [
  { images: require("@/assets/images/store/product-detail/01.jpg") },
  { images: require("@/assets/images/store/product-detail/02.jpg") },
...
const products = [
  {
    userAvatar: require("@/assets/images/user/01.jpg"),
    userName: "Paul Molive",
    productImage: require("@/assets/images/store/01.jpg"),
    offerPercentage: "30%",
    regularPrice: "$87.00",
    discountedPrice: "$75.00",
    productName: "Flaming Skull Team Logo",
    category: "Logo and badges",
    description: "Success in containing the virus comes slowing activity.",
  },
  {
    userAvatar: require("@/assets/images/user/02.jpg"),
    userName: "Paul Molive",
    productImage: require("@/assets/images/store/02.jpg"),
    offerPercentage: "30%",
    regularPrice: "$87.00",
    discountedPrice: "$75.00",
    productName: "Flaming Skull Team Logo",
  ...
  {
    userAvatar: require("@/assets/images/user/03.jpg"),
    userName: "Anna Mull",
    productImage: require("@/assets/images/store/03.jpg"),
    offerPercentage: "50%",
    regularPrice: "$87.00",
    discountedPrice: "$75.00",
    productName: "Flaming Skull Team Logo",
  ...
  {
    userAvatar: require("@/assets/images/user/04.jpg"),
    userName: "Terry Aki",
    productImage: require("@/assets/images/store/04.jpg"),
    offerPercentage: "30%",
    regularPrice: "$87.00",
    discountedPrice: "$75.00",
    productName: "Flaming Skull Team Logo",
  ...
  {
    userAvatar: require("@/assets/images/user/05.jpg"),
    userName: "Rock Lai",
    productImage: require("@/assets/images/store/05.jpg"),
    offerPercentage: "20%",
    regularPrice: "$87.00",
    discountedPrice: "$75.00",
    productName: "Flaming Skull Team Logo",
  ...
  {
    userAvatar: require("@/assets/images/user/06.jpg"),
    userName: "Cliff Hanger",
    productImage: require("@/assets/images/store/06.jpg"),
    offerPercentage: "40%",
    regularPrice: "$87.00",
    discountedPrice: "$75.00",
    productName: "Flaming Skull Team Logo",
...
const addDataDismiss = () => {
  const els = document.querySelectorAll(".btn-close");
