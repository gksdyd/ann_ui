        ...
        <div id="cart" class="cart-card-block show p-0 col-12">
          <b-row class="align-item-center">
            <b-col lg="8">
              <b-card no-body>
                <div
                  class="card-header d-flex justify-content-between iq-border-bottom mb-0"
                >
                    ...
                    <b-row class="align-items-center">
                      ...
                      <b-col sm="6">
                        <b-row>
                          <b-col sm="10" cols="10">
                            <b-row class="align-items-center">
                              <b-col sm="7" md="6" cols="8">
                                <div class="quantity buttons_added">
                                  <groupbtn />
                                </div>
                              </b-col>
                              <b-col sm="5" md="6" cols="4">
                          ...
                          <b-col sm="2" cols="2">
                            <a
                              href="#"
                              class="text-dark material-symbols-outlined"
                              >delete</a
                            >
                          </b-col>
                        </b-row>
                      ...
                      <b-col sm="2">
                        <span class="checkout-product-img">
                          <a href="#"
                            ><img
                              class="img-fluid rounded"
                              src="@/assets/images/store/03.jpg"
                              alt=""
                          /></a>
                        </span>
                      </b-col>
                      ...
                      <b-col sm="2">
                        <span class="checkout-product-img">
                          <a href="#"
                            ><img
                              class="img-fluid rounded"
                              src="@/assets/images/store/04.jpg"
                              alt=""
                          /></a>
                        </span>
                      </b-col>
            ...
            <b-col lg="4">
              <b-card no-body>
                <b-card-body>
                  ...
                  <router-link
                    :to="{ name: 'store.store-checkoutaddress' }"
                    href="#"
              ...
              <b-card no-body>
                <b-card-body class="p-0 iq-checkout-policy">
                  <ul class="p-0 m-0">
                ...
                <b-card-body>
                  <form onsubmit="required()">
                    <b-row class="mt-3">
                      ...
                      <b-col md="6">
                        <div class="form-group">
                          <label class="form-label" for="addtype"
                            >Address Type</label
                          >
              ...
              <b-card no-body>
                <b-card-body>
                  ...
                  <a
                    id="deliver-address"
                    href="#"
                    class="btn btn-primary d-block mt-1 next"
              ...
              <b-card no-body>
                ...
                <b-card-body>
                    ...
                    <div class="form-group">
                      ...
                      <div class="form-check">
                        <input
                          ...
                          name="customRadio"
                        />
                        <label class="form-check-label" for="netbaking">
                          Net Banking</label
                        >
                      </div>
                      <div class="form-check">
                  ...
                  <div class="add-card">
                    <a href="#"
                      ><span
                        ><i class="ri-add-box-line me-2 h5"></i>Add Gift
                        Card</span
                      ></a
                    >
                  </div>
...
<script>
import groupbtn from "@/components/custom/quantitybtn/quantitybtn.vue";
export default {
