                    ...
                    <div class="row mt-3">
                      ...
                      <div class="col-md-6">
                        <button
                          ...
                          @click="
                            $router.push({
                              name: 'store.store-checkoutaddress',
                            })
                          "
            ...
            <div class="col-lg-4">
              <div class="card">
                <div class="card-body">
                  ...
                  <router-link
                    id="deliver-address"
                    :to="{ name: 'store.store-checkoutpayment' }"
                    class="btn btn-primary text-white d-block mt-1 next"
                    >Deliver To this Address</router-link
                  >
                </div>
              </div>
            </div>
