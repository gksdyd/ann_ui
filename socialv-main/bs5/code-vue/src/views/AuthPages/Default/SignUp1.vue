    ...
    <div class="container-fluid">
      <div class="row align-items-center">
        <div class="col-md-6 overflow-hidden position-relative">
          <div
            class="bg-primary w-100 h-100 position-absolute top-0 bottom-0 start-0 end-0"
          ></div>
          ...
          <div class="sign-in-detail container-inside-top">
            <Swiper
              :options="options"
              class="swiper-general list-inline m-0 p-0"
            >
              <SwiperSlide>
                <img
                  src="@/assets/images/login/1.jpg"
                  class="signin-img img-fluid mb-5 rounded-3"
                  alt="logo"
                />
                <h2 class="mb-3 text-white fw-semibold">
        ...
        <div class="col-md-6">
          <div class="sign-in-from text-center">
            ...
            <p class="mt-3 font-size-16">
              Welcome to socialV, a platform to connect with<br />
              the social world
            </p>

            <form class="mt-5" @submit.prevent="onSubmit()">
              <div class="form-group text-start">
                <label class="form-label fw-bold h6" for="exampleInputEmail1"
              ...
              <div class="form-group text-start">
                <label class="form-label fw-bold h6" for="exampleInputEmail2"
                  >Email Address</label
                >
                <input
                  type="email"
              ...
              <div class="form-group text-start">
                <label class="form-label fw-bold h6" for="exampleInputPassword1"
                  >Your Password</label
                >
                <input
                  type="password"
              ...
              <div class="d-flex align-items-center justify-content-between">
                <div class="form-check d-inline-block m-0">
                  ...
                  <h6 class="form-check-label fw-500 font-size-14">
                    I accept
                    <router-link
                      :to="{ name: 'social.termofservice' }"
                      class="fw-light ms-1"
              ...
              <button
                type="button"
                class="btn btn-primary mt-4 fw-semibold text-uppercase w-100"
              >
                sign up
              </button>
              <h6 class="mt-5">
