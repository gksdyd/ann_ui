<template>
              ...
              <div class="d-flex justify-content-between">
                ...
                <div class="item4 ms-1">
                  ...
                  >
                    ...
                    >
                      <span class="material-symbols-outlined md-16"> add </span
                      >Follow
                    </button>
                  </div>
                </div>
                ...
                <div class="col-lg-5">
                  <div class="item5 mt-3">
                    <div class="d-flex align-items-center mb-1">
                      ...
                      <a href="#" class="link-primary h6 ms-2"
                        >Model at next model management</a
                      >
                    </div>
                    <div class="d-flex align-items-center mb-1">
                      <span class="material-symbols-outlined md-18">
            ...
            <div class="card-body">
              ...
              <div class="d-flex flex-column justify-content-between">
                ...
                <div class="d-flex align-items-center">
                  ...
                  <span
                    >Lives in
                    <a href="#" class="link-primary">Tbilisi, Georgia</a></span
                  >
                </div>
              </div>
            </div>
                  ...
                  >
                    <a data-fslightbox="gallery">
                      <img
                        ...
                        class="img-fluid bg-info-subtle img-size"
                        loading="lazy"
                      />
                    </a>
                  </div>
                  ...
                  <div class="d-flex justify-content-between">
                    ...
                    <div class="w-100 text-margin">
                      ...
                      <small class="d-flex align-items-center">
                        <i class="material-symbols-outlined md-14 me-1">
                          schedule
                        </i>
                        March 14, 23:00</small
                      >
                      <p>
                        Hi, I am flying to Los Angeles to attend #VSFS2020
                        castings. I hope it will happen and my dream comes true.
                        Wish me luck.
                      </p>
                      <hr />
                      <div
                      ...
                      >
                        ...
                        <span class="card-text-2"> 5.2k people love it </span>
                        <div
                          class="d-flex justify-content-between align-items-center"
                        >
                          <span class="card-text-1 me-1"
                            >5.2k people love it</span
                          >
                          <div class="iq-media-group ms-2">
                            <a href="#" class="iq-media">
                              <img
                ...
                <li class="mb-2">
                  <div class="d-flex justify-content-between">
                    ...
                    <div class="w-100 text-margin">
                      ...
                      <span class=""
                        >Photoshoot for Buyers Magazine - 2019</span
                      >
                      <hr />
                      <div
                        class="d-flex justify-content-between align-items-center flex-wrap"
  ...
  <FsLightbox
    ...
    :sources="[
      ...
      require('@/assets/images/page-img/51.jpg'),
      require('@/assets/images/page-img/52.jpg'),
      require('@/assets/images/page-img/53.jpg'),
      require('@/assets/images/page-img/54.jpg'),
      require('@/assets/images/page-img/55.jpg'),
