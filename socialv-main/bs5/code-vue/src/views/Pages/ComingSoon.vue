          ...
          <div class="row justify-content-center">
            <div class="col-md-8 text-center">
              <div class="iq-comingsoon-info">
                ...
                <ul class="countdown row list-inline" data-date="Dec 31 2024 23:59:59" ref="countdown">
...
import { useCountdown } from "../../plugins/countdown/countdown.js";
export default {
  name: "ComingSoon",
  mounted() {
    const countdownElement = this.$refs.countdown;
    useCountdown(countdownElement);
  },
};
</script>
