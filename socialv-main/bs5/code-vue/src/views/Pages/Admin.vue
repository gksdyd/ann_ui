              ...
              <div class="d-flex justify-content-between flex-wrap">
                ...
                <div class="dropdown">
                  ...
                  <ul
                    ...
                    aria-labelledby="dropdownMenuButton223"
                  >
                    <li>
              ...
              >
                <div class="d-grid gap col-md-4 col-lg-4 gap-3">
                  <div class="d-flex align-items-start">
                    <i
                      class="icon material-symbols-outlined filled text-primary mt-1"
                    >
                      fiber_manual_record
                    </i>
                  ...
                  <div class="d-flex align-items-start">
                    <i
                      class="icon material-symbols-outlined filled text-info mt-1"
                    >
                      fiber_manual_record
                    </i>
                    <div class="ms-2" style="line-height: 1.5">
                ...
                <apexchart
                  height="200"
                  type="radialBar"
                  class="col-md-8 col-lg-8 admin-chart-03"
            ...
            <div class="card-header">
              <div class="d-flex justify-content-between flex-wrap">
                ...
                <div class="dropdown">
                  ...
                  <ul
                    class="dropdown-menu dropdown-menu-end"
                    aria-labelledby="dropdownMenuButton222"
                  >
                    <li>
                      <a class="dropdown-item" href="#">Year</a>
                    </li>
          ...
          <div class="card">
            ...
            <div class="card-body text-center pt-0">
              <apexchart
                ...
                width="350"
                style="min-height: 259.367px"
                type="pie"
                :options="adminChart1.options"
                :series="adminChart1.series"
              />
              <p class="mb-0 mt-3 font-size-12 fw-500">
                58% of friends that visit your profile comment on your posts.
              </p>
            </div>
          </div>
        </div>
