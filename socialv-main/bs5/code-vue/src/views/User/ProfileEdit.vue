            ...
            <div class="iq-card-body p-0">
              <div class="iq-edit-list">
                <tab-nav
                  :pills="true"
                  id="pills-tab"
                  class="iq-edit-profile row mb-0 nav nav-pills"
                >
                  <tab-nav-items
                    class="col-sm-3 p-0"
                    :active="true"
...
Zip Code: 85001
              ...
              <tab-content-item
                :active="false"
                id="emailandsms"
                aria-labelled-by="pills-sms-tab"
              >
                <iq-card>
                  <template v-slot:headerTitle>
                        ...
                        <div class="col-md-9">
                          ...
                          <div class="form-check d-block">
                            <input
                              ...
                              id="email02"
                            />
                            <label class="form-check-label" for="email02"
                          ...
                          <div class="form-check d-block">
                            <input
                              ...
                              checked=""
                            />
                            <label class="form-check-label" for="email03"
                        ...
                        <div class="col-md-9">
                          ...
                          <div class="form-check d-block">
                            <input
                              ...
                              id="email05"
                            />
                            <label class="form-check-label" for="email05"
                          ...
                          <div class="form-check d-block">
                            <input
                              ...
                              checked=""
                            />
                            <label class="form-check-label" for="email06"
